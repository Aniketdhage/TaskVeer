                  ...
                  {total === 0 ? (
                    ...
                    <>
                      ...
                      {[
                        ...
                        {
                          label: 'In Progress',
                          count: stats.statusCounts['in-progress'],
                          icon: Timer,
                          color: 'text-blue-500',
                          bar: 'bg-blue-400',
                        },
                        {
                          label: 'Testing',
                          count: stats.statusCounts.testing,
                          icon: FlaskConical,
                      ...
                      <div className="pt-3 border-t">
                        ...
                        <div className="flex gap-3">
                          {[
                            ...
                            <div
                              key={label}
                              className={`flex-1 rounded-xl border ${border} ${bg} px-3 py-2 text-center`}
                            >
                    ...
                    >
                      ...
                      <div>
                        <p className="text-xs font-semibold text-red-700">
                          {stats.overdueCount} overdue task
                          {stats.overdueCount > 1 ? 's' : ''}
                        </p>
                        <p className="text-xs text-red-500 mt-0.5">
                          Review and update their due dates.
                        </p>
                      </div>
                    </motion.div>
                  )}
